...
{                                                              \
    if(0 == whichTaskFlag)                                     \
    {                                                          \
        displayData_TimeAtTake = xTaskGetTickCount();          \
    }                                                          \
    else if(1 == whichTaskFlag)                                \
    {                                                          \
        runTimeMeasurements_TimeAtTake = xTaskGetTickCount();  \
    }                                                          \
}while(0);
...
{                                                                                                         \
    if(0 == whichTaskFlag)                                                                                \
    {                                                                                                     \
        displayData_TimeAtGive = xTaskGetTickCount();                                                     \
        displayData_LockTime += displayData_TimeAtGive - displayData_TimeAtTake;                          \
        whichTaskFlag = 1;                                                                                \
    }                                                                                                     \
    else if(1 == whichTaskFlag)                                                                           \
    {                                                                                                     \
        runTimeMeasurements_TimeAtGive = xTaskGetTickCount();                                             \
        runTimeMeasurements_LockTime += runTimeMeasurements_TimeAtGive - runTimeMeasurements_TimeAtTake;  \
        whichTaskFlag = 0;                                                                                \
    }                                                                                                     \
}while(0);
